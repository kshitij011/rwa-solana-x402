...
export function KYCSection({ isConnected, kycStatus, onStartKYC, onConnect }: KYCSectionProps) {
  ...
  return (
    <section id="kyc" className="py-24 px-6 bg-gradient-to-b from-background via-card/50 to-background">
          ...
          <div className="p-8 rounded-3xl bg-gradient-card border border-border">
            ...
            {!connected ? (
              <div className="space-y-4">
                ...
                <Button variant="gold" size="lg" onClick={onConnect} className="w-full">
